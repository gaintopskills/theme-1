...
export const Gallery4 = () => {
    ...
    const images = [
        ...
        { src: "/patches/los-angeles-digital-sublimation-photographic-embroidery-photorealistic-embroidery-lips-golden-teeth-custom-clothing.webp", album: "Embroidery" },
        { src: "/patches/best-custom-patches-los-angeles-la-red-jacket-cactus.webp", album: "Embroidery" },
        { src: "/patches/high-fashion-patches-los-angeles-la-frame-denim-black-leather-jacket.webp", album: "Embroidery" },
        { src: "/patches/high-quality-custom-patches-los-angeles-beastie-fiery-lion-black-and-white-jacket.webp", album: "Embroidery" },
        { src: "/patches/los-angeles-patches-la-sublimation-and-embroidery-guns-n-roses.webp", album: "Embroidery" },
