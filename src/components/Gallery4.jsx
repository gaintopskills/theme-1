...
export const Gallery4 = () => {
    ...
    const images = [
        { src: "https://www.eandrunlimited.com/wp-content/uploads/2017/05/dtla-los-angeles-custom-embroidery-selena-gomez-custom-selebrity-jacket.jpg", album: "Embroidery" },
