...
export const Navbar = () => {
  ...
  return (
    <nav
      className="w-full h-20 flex flex-col justify-center items-center fixed bg-black lg:bg-blackTransparent z-40 lg:backdrop-blur-xl bg-opacity-70"
      ...
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
                    ...
                    {subMenuOpen && (
                      ...
                      >
                        {children.map((child) => (
                          <div
                            key={child.label}
                            className="mega-menu-column flex flex-col items-center bg-black px-4 rounded-md"
                          >
                            <img
                              src={child.image}
                              alt={child.label}
        ...
        >
          <div className="grow basis-0 justify-end hidden lg:flex">
            <a
              className="text-white main-border-gray rounded-xl bg-bgDark2 hover:bg-bgDark3 border-gray-700 pl-4 pr-6 pt-2 pb-2 text-sm flex"
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col mt-16 lg:hidden absolute top-4 left-0 bg-bgDark1 z-50 w-full items-center gap-10 pb-10 border-y border-solid border-bgDark3 pt-10">
                    ...
                    <ul className="pl-2">
                      {children.map((child) => (
                        <li key={child.label}>
                          <a
                            href={child.href}
                            className="text-white text-lg py-1 block hover:scale-110 transition duration-300"
              ...
              <a
                className="outlined-button pl-4 pr-6 pt-2 pb-2 flex"
                href="https://github.com/matt765/Tidestream"
                target="_blank"
              >
                Call: (323)584-3000
