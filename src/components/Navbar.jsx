    ...
    children: [
      {
        label: 'Sub-feature 1',
        href: '/sub-feature1',
        ariaLabel: 'Sub-feature 1',
      },
      {
        label: 'Sub-feature 2',
        href: '/sub-feature2',
        ariaLabel: 'Sub-feature 2',
      },
      {
        label: 'Sub-feature 3',
        href: '/sub-feature3',
        ariaLabel: 'Sub-feature 3',
      },
      {
        label: 'Sub-feature 4',
        href: '/sub-feature4',
        ariaLabel: 'Sub-feature 4',
      },
      {
        label: 'Sub-feature 5',
        href: '/sub-feature5',
        ariaLabel: 'Sub-feature 5',
      },
      {
        label: 'Sub-feature 6',
        href: '/sub-feature6',
        ariaLabel: 'Sub-feature 6',
      },
    ],
  },
                    ...
                    {subMenuOpen && (
                      ...
                      >
                        <div className="mega-menu-column bg-black flex-1 px-8 rounded-tl-lg rounded-bl-lg">
                          <h3 className="text-white mb-3 text-xl w-40">
                            Column 1
                          </h3>
                          <ul>
                            {children.slice(0, 2).map((child) => (
                              <li key={child.label}>
                                <a
                                  href={child.href}
                                  className="block px-4 py-2 text-white hover:bg-gray-700 rounded w-40"
              ...
              {navbarLinks.map(({ label, href, ariaLabel, children }) => (
                <div key={label} className="relative">
                  <a
                    ...
                    onClick={
                      children && label === 'Features'
                        ? toggleSubMenu
                        : () => setIsOpen(false)
                    } // Toggle submenu on "Features" click
                    aria-label={ariaLabel}
                  >
                    {label}
                  </a>
