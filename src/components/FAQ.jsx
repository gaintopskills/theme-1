...
export const FAQ = () => (
  <section className="relative -mt-8 sm:mt-0 pt-12 sm:pt-16 pb-16 overflow-hidden">
...
const FAQBox = ({ defaultOpen, title, content }) => {
  ...
  return (
    <div
      className="pt-2 sm:pt-6 pb-2 px-3 sm:px-8  rounded-3xl bg-black main-border-gray-darker mb-4 relative hover:bg-bgDark3Hover cursor-pointer transition"
